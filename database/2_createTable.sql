...
CREATE TABLE IF NOT EXISTS brands (
    ...
    upload_status   ENUM('pending_upload', 'uploading', 'completed', 'failed') NOT NULL DEFAULT 'completed',
    ...
    INDEX idx_brand_upload_status (upload_status)
...
CREATE TABLE IF NOT EXISTS banners (
    ...
    sort_order INT NOT NULL DEFAULT 0,
    status ENUM('active', 'inactive') NOT NULL DEFAULT 'active',
    upload_status ENUM('pending_upload','uploading','completed','failed') DEFAULT 'completed',
    local_path VARCHAR(500) NULL,
    cloud_public_id VARCHAR(255) NULL,
